...
<table>
    <tr>
        ...
        <th width="35%" class="text-center">Sheave Wear<br>Check Photograph</th>
        <th width="35%" class="text-center">Sheave Groove<br>Check Photograph</th>
    </tr>
    <tr>
        ...
        <td class="text-center">
            @if($record->sheave_wear_photo && file_exists(storage_path('app/public/' . $record->sheave_wear_photo)))
                <img src="{{ storage_path('app/public/' . $record->sheave_wear_photo) }}" style="height:200px; border:1px solid #000;">
            @else
        ...
        <td class="text-center">
            @if($record->sheave_groove_photo && file_exists(storage_path('app/public/' . $record->sheave_groove_photo)))
                <img src="{{ storage_path('app/public/' . $record->sheave_groove_photo) }}" style="height:200px; border:1px solid #000;">
            @else
                <div style="height:200px; border:1px solid #000; padding-top: 90px; text-align:center;">Photo Not Available</div>
            @endif
        </td>
