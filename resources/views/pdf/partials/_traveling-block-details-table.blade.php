<table class="bordered" style="font-size: 6.5pt;">
    ...
    <tr>
        ...
        <td>
            ...
            @if($record->inspection_method == 2) @svg('heroicon-o-check', 'icon-check') Fluorescent @else @svg('heroicon-o-x-mark', 'icon-sign') Fluorescent @endif
        </td>
    ...
    <tr>
        ...
        <td class="bg-grey">Manufacturer:</td>
        <td>{{ $record->contrast_media_manuf }}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="bg-grey">Sheaves SN:</td>
        <td colspan="3">{{ $record->sheaves_sn }}</td>
    </tr>
    <tr>
        <td class="bg-grey">Sheaves SN (Disc):</td>
        <td colspan="5">{{ $record->sheaves_sn_disc }}</td>
    </tr>
    </tbody>
</table>
